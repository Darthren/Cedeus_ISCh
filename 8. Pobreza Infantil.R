...
pob_2015 <- read_excel(path = "poblacion_2015.xlsx" )
...
casen2015 <- as.data.frame(fread("CASEN_2015.csv", sep=",", header= T, select = c(7,18,707,745,737)))

lpobreza <- as.data.frame(fread("Linea de pobreza y linea de probreza extrema 2015.csv", sep=",", header= T))
